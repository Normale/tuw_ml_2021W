...
class Dataset:
    ...
    def calcENPrediction(self, alpha=0.5, l1_ratio=0.5):
        en = EN(self.xTest, self.xTrain, self.yTrain, alpha, l1_ratio)  # Params: alpha, l1_ratio
    ...
    def calcRFPrediction(self, n=50):
        rf = RF(self.xTest, self.xTrain, self.yTrain, n)  # Params: n_estimators
    ...
    def calcSVMPrediction(self, kernel='linear', C=1.0, eps=0.1):
        svm = SVM(self.xTest, self.xTrain, self.yTrain, kernel=kernel, C=C, eps=eps)  # Params: C, eps, kernel
